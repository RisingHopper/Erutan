...
//Receptores. Podemos añadir más de uno. El segundo argumento es opcional, es el nombre
    ...
    //Conteido HTML
    $mail->Body    = "Hola $username, tu cuenta ha sido creado correctamente. Solo queda un paso, verifica tu cuenta accediendo en este enlace: "."http://localhost/dwes/ProyectoGerai/web/index.php?ctl=verificarCuenta&token=$tokenUsuario";
