...
//Receptores. Podemos añadir más de uno. El segundo argumento es opcional, es el nombre
    ...
    But there is one step more, please verify your account.<br>
    Is very easy, use this link ==> "."http://localhost/dwes/theErutan/web/index.php?ctl=verificarCuenta&token=$tokenUsuario";
