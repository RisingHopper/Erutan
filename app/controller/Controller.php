...
class Controller {
    ...
    public function inicio() {      
        ...
        // );
        $params = array(
            'es' => $m->listarPublicacionEs(),
            'en' => $m->listarPublicacionEn(),
        );
    ...
    public function salir() {
        ...
        session_destroy();
        header ("location:index.php?ctl=inicio&lang=$idioma");
    }
    ...
    public function paginaAnimales() {      
        ...
        try {
            ...
            $categoria="animales";
            $params = array(
                'es' => $m->listarPublicacionCategoria($categoria,"es"),
                'en' => $m->listarPublicacionCategoria($categoria,"en"),
    ...
    public function buscarPost()
    {
        try {
            ...
            if (isset($_POST['namePost'])) {
                $nombre = recoge("namePost");
                $idioma=$_SESSION['lang'];
                $params['nombre'] = $nombre;
                $params['resultado'] = $m->buscarPostPorNombre($nombre,$idioma);
            }
        } catch (Exception $e) {
        ...
        require __DIR__ . '/../../web/pages/buscarPost.php';
    }
    ...
    public function registro() {
        ...
        if (isset($_POST['bRegistro'])) {
            ...
            cNombre($nombreCompleto, "nombreCompleto", $errores);
        ...
        try{
            if (isset($_POST['bSubir'])){
                ...
                if (empty($errores)) {
                    ...
                    $m = new Erutan();
                    if ($m->insertarPublicacion($titulo,$tituloPost,$contenidoCard,$contenidoPost,$categoria,$imagen,$contenidoCarrusel,$idioma)) {
