...
<div class="container-fluid ">
    ...
    <table class="col-12 col-md-10 g--font-size-24 mx-auto">
      ...
      <tr class="g--bg-lightskyblue d-flex justify-content-between align-items-center px-3 g--border-bottom-grey g--height-50">
        <td>
          <?php echo $newsletter['dateSend']; ?>
          &nbsp&nbsp&nbsp
        <?php echo $newsletter['titulo']; ?></td>
          <td class="d-flex g--font-size-18">
          <a href="index.php?ctl=verNewsletter&idTitulo=<?php echo $newsletter['titulo']?>" class="nav-link link-dark me-3 g--hover-white-text">
          <i class="fa-solid fa-eye"></i>
            View
          </a>
          <a href="index.php?ctl=editarNewsletter&idTitulo=<?php echo $newsletter['titulo']?>" class="nav-link link-dark me-3 g--hover-white-text">
          <i class="fa-solid fa-pen-to-square"></i>
            Edit
          </a>
          <a href="index.php?ctl=enviarNewsletter&idTitulo=<?php echo $newsletter['titulo']?>" class="nav-link link-dark me-3 g--hover-white-text">
          <i class="fa-solid fa-paper-plane"></i>
            Send
          </a>
          <a href="index.php?ctl=borrarNewsletter&idTitulo=<?php echo $newsletter['titulo']?>" class="nav-link link-dark g--hover-white-text">
