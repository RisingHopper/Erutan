...
<div class="error">
  ...
  <button class="error__button error__button--active"><a class="text-decoration-none" href="http://localhost/DWES/theErutan/web/index.php?ctl=inicio">HOME</a></button>
</div>
