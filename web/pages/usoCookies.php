...
<div class="container-fluid">
	<div class="row mb-2 justify-content-md-center justify-content-lg-start" id="secondaryIndex" >
		...
		<div class="col-lg-2 col-md-1 col-2">
			<h4><a href="index.php?ctl=politicaPrivacidad">Cookies</a></h4>
		</div>
	</div>
	...
	<div class="row my-4 bg-light secondaryText">
		...
		<p class="px-5 st3">Browsing this portal means that the following types of cookies can be installed:</p>
			<ol class="px-5">
