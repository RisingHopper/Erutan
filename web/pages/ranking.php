                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="card-text g--font-size-20">With a total of <?php echo $posts['SUM(respuestasAcertadas)'] ?> points</p>
                                ...
                                <a href="#" class="btn btn-primary fw-bold"><?php echo $jugadorId." position"?></a>
