	...
	<div class="col-10 mx-auto mt-5">
		...
		<div class="row mx-0 g--border-black p-2">
			<div class="col-3 px-0 pe-2">
				<img style="width: 100%;" src="<?php echo $params['newsletter']['imagen']; ?>">
				<?php $imgName=$params['newsletter']['imagen'];
					  $imgName=substr($imgName,26);
				?>
				<p class="text-center fw-bold mt-1"><?php echo $imgName; ?></p>
				<!-- <form class="w-100"action="index.php?ctl=enviarNewsletter&idTitulo=<?php echo $params['newsletter']['titulo']?>" method="Post">
					<input type="submit" value="Edit" name="bSubir"/>
				</form>
				<form action="index.php?ctl=enviarNewsletter&idTitulo=<?php echo $params['newsletter']['titulo']?>" method="Post">
					<input type="submit" value="Send" name="bSubir"/>
				</form>
				<form action="index.php?ctl=borrarNewsletter&idTitulo=<?php echo $params['newsletter']['titulo']?>" method="Post">
				...
				<div class="bg-danger g--border-black ps-2 mt-1 g--hover-bg-black"><a class="text-decoration-none text-white" href="index.php?ctl=enviarNewsletter&idTitulo=<?php echo $newsletter['titulo']?>">Send</a></div>
				<div class="bg-danger g--border-black ps-2 mt-1 g--hover-bg-black"><a class="text-decoration-none text-white" href="index.php?ctl=borrarNewsletter&idTitulo=<?php echo $params['newsletter']['titulo']?>">Delete</a></div>
			</div>
