...
<script src="javascript/informacion.js"></script>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>

<form method="POST" ACTION="index.php?ctl=actualizaDatos">
  ...
  <div class="containerRegister my-5">
  <div class="row">
  <div class="col-12 text-center"><h1>Personalization<h1></div>
      <div class="col-12">
