...
<div class="container-fluid">
    ...
    <div class="col-md-8 col-12 my-5">
      ...
      <h2 class="text-center fw-bold text-uppercase"><?=$lang["publicaciones"]["chat"]?></h2>
      </div>
      ...
      <form method="POST" id="comment_form">
        ...
        <input type="submit" name="submit" id="submit" class="px-5 py-1 bg-black text-white g--font-size-22 fw-semibold" value="<?=$lang["publicaciones"]["submit"]?>" />
        </div>
      </form>
      </div>
    ...
    <div class="d-none d-md-block col-2 g--bg-img-foro">
