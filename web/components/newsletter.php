...
<div class="col-md-12 bg-black d-flex flex-wrap text-white g--border-inset">
  ...
  <div class="col-12 col-md-8">
    ...
    <form class="px-2 px-md-5 mb-3" action="index.php?ctl=subscribir" method="POST">
      <div class="mb-3">
        <input type="text" class="col-12 col-md-3 g--height-40 me-2 mb-1 mb-md-0" name="nombre" placeholder=<?=$lang["newsletter"]["name"]?>>
        <input type="email" class="col-12 col-md-3 g--height-40 me-2 mb-1" name="email" placeholder=<?=$lang["newsletter"]["email"]?>>
        <input type="phone" class="col-12 col-md-3 g--height-40" name="phone" placeholder=<?=$lang["newsletter"]["tlf"]?>>
      </div>
