      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item g--font-size-20" href="index.php?ctl=posts">All Posts</a></li>
            <li><a class="dropdown-item g--font-size-20" href="index.php?ctl=paginaPeople">People</a></li>
            <li><a class="dropdown-item g--font-size-20" href="index.php?ctl=paginaAnimales">Animals</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle g--color-ff74fc g--hover-black-text" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
