  ...
  <div class="container-fluid">
    ...
    <div class="z-3 collapse navbar-collapse g--margin-left-330" id="navbarSupportedContent"> 
      ...
      <div class="d-flex">
        ...
        <a href="index.php?ctl=datosPersonales&idUser=<?php echo $_SESSION['idUser'];  ?>" ><img src="<?php echo $_SESSION['fotoPerfil']; ?>" alt="" style="width:38px; height:38px; object-fit: cover;" class="me-2 g--border-black"></a>
