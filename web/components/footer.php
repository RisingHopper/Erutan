  ...
  <footer class="px-3">
    <div class="row">
      <div class="col-12 col-md-4 mb-3 text-white g--font-size-20">
        ...
        <div class="mb-4">
            <a href="index.html"><img class="g--width-250" src="assets/img/logoWhite.png" alt="logo"></a>
        </div>
        <div class="">
            <p>If you like this content. You can support us by sharing with your friends!
                <br>And remember, when the Nature calls we obey...
            </p>
        </div>
      ...
      <div class="offset-md-2 col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column mt-3">
          <li class="nav-item mb-2"><a class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="#" class="nav-link p-0 text-body-secondary">Log In</a></li>
          <li class="nav-item mb-2"><a class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="#" class="nav-link p-0 text-body-secondary">About Erutan</a></li>
          <li class="nav-item mb-2"><a class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="#" class="nav-link p-0 text-body-secondary">FAQs</a></li>
      ...
      <div class="col-6 col-md-2 mb-3">
        <h3>Policy private</h3>
        <ul class="nav flex-column mt-3">
          <li class="nav-item mb-2"><a class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="#" class="nav-link p-0 text-body-secondary g--color-b5a7a7">cookies</a></li>
          <li class="nav-item mb-2"><a class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="#" class="nav-link p-0 text-body-secondary g--color-b5a7a7">Features</a></li>
