    ...
    <div class="row">
      ...
      <div class="offset-md-2 col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column mt-3">
          <li class="nav-item mb-2"><a data-bs-toggle="modal" data-bs-target="#exampleModals" class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="#" class="nav-link p-0 text-body-secondary">Log In</a></li>
          <li class="nav-item mb-2"><a class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="index.php?ctl=aboutPage" class="nav-link p-0 text-body-secondary">About Erutan</a></li>
      ...
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column mt-3">
          ...
          <li class="nav-item mb-2"><a class="text-decoration-none g--color-b5a7a7 g--font-size-20" href="index.php?ctl=privacidadPage" class="nav-link p-0 text-body-secondary g--color-b5a7a7">Privacy Policy</a></li>
